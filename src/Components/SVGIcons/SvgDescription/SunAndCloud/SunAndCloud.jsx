...
import "./SunAndCloud.scss"


export const SunAndCloud = () => {

    return (
        <div className="block-cloud">
            <div className="preloader" style={{ opacity: 1 }}>
                <svg version="1.1" id="sun" className="sun-cloud block-cloud__cloud" xmlns="http://www.w3.org/2000/svg"
                    width="10px" height="10px"
                    viewBox="0 0 10 10" enable-background="new 0 0 10 10"
                    style={{ opacity: 1, marginLeft: "0px", marginTop: "0px" }}>
                    <g>
                        <path fill="none"
                            d="M6.942,3.876c-0.4-0.692-1.146-1.123-1.946-1.123c-0.392,0-0.779,0.104-1.121,0.301c-1.072,0.619-1.44,1.994-0.821,3.067C3.454,6.815,4.2,7.245,5,7.245c0.392,0,0.779-0.104,1.121-0.301C6.64,6.644,7.013,6.159,7.167,5.581C7.321,5,7.243,4.396,6.942,3.876z">
                        </path>
                        <path fill="none"
